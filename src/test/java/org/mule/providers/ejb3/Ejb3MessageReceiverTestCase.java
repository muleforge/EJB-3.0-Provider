...
import org.mule.providers.ejb3.Ejb3MessageReceiver;
...
public class Ejb3MessageReceiverTestCase extends AbstractMessageReceiverTestCase
{
    ...
    public UMOMessageReceiver getMessageReceiver() throws Exception
    {
        ...
        return new Ejb3MessageReceiver(endpoint.getConnector(), (UMOComponent) mockComponent.proxy(), endpoint, 1000);
    }
