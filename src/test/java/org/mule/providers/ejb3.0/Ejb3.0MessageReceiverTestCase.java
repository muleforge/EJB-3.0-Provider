...
package org.mule.providers.ejb3.0;

import com.mockobjects.dynamic.Mock;
import org.mule.impl.endpoint.MuleEndpoint;
import org.mule.providers.AbstractConnector;
import org.mule.providers.ejb3.0.Ejb3.0MessageReceiver;
...
public class Ejb3.0MessageReceiverTestCase extends AbstractMessageReceiverTestCase
{
    ...
    public UMOMessageReceiver getMessageReceiver() throws Exception
    {
        ...
        return new Ejb3.0MessageReceiver(endpoint.getConnector(), (UMOComponent) mockComponent.proxy(), endpoint, 1000);
    }
